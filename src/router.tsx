    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'forgot-password', lazy: lazy(() => import('@/features/auth/ForgotPasswordPage')) },
        ],
      },
      {
        element: <RequireUser />,
        children: [{ path: 'onboarding', lazy: lazy(() => import('@/features/onboarding/OnboardingPage')) }],
      },
      {
        path: 'app',
        element: <RequireApp />,
        children: [
          {
            ...
            children: [
              { index: true, lazy: lazy(() => import('@/features/dashboard/overview/OverviewPage')) },
              { path: 'analytics', lazy: lazy(() => import('@/features/dashboard/analytics/AnalyticsPage')) },
              { path: 'customers', lazy: lazy(() => import('@/features/dashboard/customers/CustomersPage')) },
              ...
              { path: 'billing', lazy: lazy(() => import('@/features/dashboard/billing/BillingPage')) },
              { path: 'settings', lazy: lazy(() => import('@/features/dashboard/settings/SettingsPage')) },
            ],
          },
        ],
      },
